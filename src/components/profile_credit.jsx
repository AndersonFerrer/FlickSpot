...
export default function ProfileCredit ({ profilePath, originalName, job }) {
  return (
    <div className='flex xl:flex-row-reverse items-center justify-center gap-2'>
      ...
      <div className='flex flex-col items-start xl:items-end justify-center'>
        <h1 className='text-sm'>{originalName}</h1>
        <p className='text-sm text-start xl:text-end text-gray-700'>{job}</p>
      </div>
    </div>
  )
}
